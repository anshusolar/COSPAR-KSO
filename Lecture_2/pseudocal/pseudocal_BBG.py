...
Lecture 2.9b/9 Pseudo calibration and black background
...
mypath = '/home/kathir/home/kathir/kathir9_plans_projects/PROJECTS/meetings/KSO2020/MONSTEIN_SOFTWARE/Lecture_2/data/' # Edit!!!
...
fig.patch.set_facecolor('blue') # make blue background
bgs_methode = 1
if (bgs_methode==1):
    timemarker=5
    ref =  data[:,timemarker]
    bgs = np.transpose(np.transpose(data) - ref)  # subtract average individual 
else:
...
dB = bgs/digitrange * voltagerange/sensitivity # calibration

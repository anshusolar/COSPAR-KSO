...
paths = glob.glob('GREEN*.fit.gz') # file local to this script
print(len(paths))
print(paths)
FreqRange = [20,80]
...
data=data_full.reshape((ff,int(data_full.shape[0]/ff),tt,-1)).mean(axis=3).mean(1)
...
myfile    = 'go1420160504.fits' # file local to this script

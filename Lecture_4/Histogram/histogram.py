...
Lecture 4.4/9 Plot histogram of random number distributions
...
y1 = [random.gauss(4,1) for _ in range(900)]
y2 = [random.gauss(6,2) for _ in range(1000)]

bins = numpy.linspace(0, 10, 60)  # -> x.axis

plt.hist(y1, bins, alpha=0.9,color='r',histtype='bar',linewidth=3.0)
